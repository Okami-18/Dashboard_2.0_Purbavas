...
export default function Dashboard() {
  ...
  return (
    <div className="light-dashboard flex min-h-screen overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="p-4 md:p-6 max-w-[1800px] mx-auto">
            ...
            {activeTab === "alerts" && (
              <div>
                <div className="mb-4">
                  <h2 className="text-lg font-black text-white">Incident Command</h2>
                  <p className="text-xs text-slate-500">
                    Verified edge-AI alerts, confidence signals and responder actions
                  </p>
                </div>
                <AlertsFeed
                  alerts={alerts}
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <span className="text-[10px] text-slate-600">
                Purbavas Edge Network v1.0
              </span>
              <span className="text-[10px] text-slate-600">
                © 2026 THE WATCHERS · SIH
              </span>
            </div>
          </div>
        </footer>
