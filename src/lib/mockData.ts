...
export const INITIAL_NODES: SensorNode[] = [
  {
    id: "ESP32-001",
    name: "Brahmaputra Watch",
    location: { lat: 26.18, lon: 91.75, zone: "Assam · Flood-prone belt" },
    status: "Online",
    wifiSignal: -45,
    batteryLevel: 87,
    solarInput: 4.2,
  ...
  {
    id: "ESP32-002",
    name: "Kaziranga Canopy",
    location: { lat: 26.58, lon: 93.17, zone: "Assam · Forest fringe" },
    status: "Online",
    wifiSignal: -62,
    batteryLevel: 73,
    solarInput: 3.8,
  ...
  {
    id: "ESP32-003",
    name: "Delhi Air Sentinel",
    location: { lat: 28.61, lon: 77.21, zone: "Delhi-NCR · Urban ward" },
    status: "Online",
    wifiSignal: -38,
    batteryLevel: 92,
    solarInput: 2.1,
  ...
  {
    id: "ESP32-004",
    name: "Uttarakhand Slope",
    location: { lat: 30.32, lon: 78.03, zone: "Uttarakhand · Himalayan slope" },
    status: "Online",
    wifiSignal: -71,
    batteryLevel: 55,
    solarInput: 5.1,
  ...
  {
    id: "ESP32-005",
    name: "Kosi River Guard",
    location: { lat: 25.62, lon: 85.13, zone: "Bihar · River basin" },
    status: "Online",
    wifiSignal: -54,
    batteryLevel: 68,
    solarInput: 4.9,
  ...
  {
    id: "ESP32-006",
    name: "Kerala Heat Watch",
    location: { lat: 9.93, lon: 76.27, zone: "Kerala · Coastal district" },
  ...
  },
  {
    id: "ESP32-007",
    name: "Himachal Ridge",
    location: { lat: 31.10, lon: 77.17, zone: "Himachal Pradesh · Ridge" },
    status: "Online",
    wifiSignal: -49,
    batteryLevel: 81,
    solarInput: 6.3,
  ...
  },
  {
    ...
    location: { lat: 22.40, lon: 88.88, zone: "West Bengal · Wetland" },
    status: "Online",
    wifiSignal: -58,
    batteryLevel: 76,
    solarInput: 3.5,
  ...
  },
  {
    id: "ESP32-009",
    name: "Tehri Summit",
    location: { lat: 30.38, lon: 78.48, zone: "Uttarakhand · Summit station" },
    status: "Offline",
    wifiSignal: -95,
    batteryLevel: 12,
    solarInput: 0,
  ...
  },
  {
    id: "ESP32-010",
    name: "Punjab Plains",
    location: { lat: 30.90, lon: 75.86, zone: "Punjab · Agricultural plain" },
    status: "Online",
    wifiSignal: -43,
    batteryLevel: 95,
    solarInput: 7.2,
...
export const INITIAL_ALERTS: Alert[] = [
  {
    id: "ALT-001",
    nodeId: "ESP32-001",
    nodeName: "Brahmaputra Watch",
    zone: "Assam · Flood-prone belt",
    hazardType: "Flood",
    riskLevel: "Critical",
    confidence: 91,
  ...
  },
  {
    id: "ALT-002",
    nodeId: "ESP32-002",
    nodeName: "Kaziranga Canopy",
    zone: "Assam · Forest fringe",
    hazardType: "Fire",
    riskLevel: "Alert",
    confidence: 88,
  ...
  },
  {
    id: "ALT-003",
    nodeId: "ESP32-003",
    nodeName: "Delhi Air Sentinel",
    zone: "Delhi-NCR · Urban ward",
    hazardType: "Pollution",
    riskLevel: "Alert",
    confidence: 94,
  ...
  },
  {
    id: "ALT-004",
    nodeId: "ESP32-006",
    nodeName: "Kerala Heat Watch",
    zone: "Kerala · Coastal district",
    hazardType: "Extreme Heat",
    riskLevel: "Alert",
    confidence: 83,
  ...
  },
  {
    id: "ALT-005",
    nodeId: "ESP32-004",
    nodeName: "Uttarakhand Slope",
    zone: "Uttarakhand · Himalayan slope",
    hazardType: "Landslide",
    riskLevel: "Precursor Detected",
    confidence: 76,
  ...
  },
  {
    id: "ALT-006",
    nodeId: "ESP32-009",
    nodeName: "Tehri Summit",
    zone: "Uttarakhand · Summit station",
    hazardType: "Normal",
    riskLevel: "Normal",
    confidence: 0,
    timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
    message: "Node went offline. Last battery level: 12%. No solar input.",
    recommendation: "Dispatch maintenance team to Tehri Summit node.",
    acknowledged: false,
    notified: false,
  },
];
...
export const REGION_STATS = {
  ...
  activeAlerts: 3,
  avgAQI: 62,
  highestRiskZone: "Assam · Flood-prone belt",
