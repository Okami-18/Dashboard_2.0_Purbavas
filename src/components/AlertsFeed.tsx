...
export default function AlertsFeed({
  ...
  return (
    <div className="flex flex-col bg-slate-800/70 border border-slate-700/80 ring-1 ring-red-500/20 shadow-2xl shadow-red-950/25 rounded-2xl overflow-hidden transition-all duration-300">
